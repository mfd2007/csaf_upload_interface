...
public class SucessResponse  implements Response {
  @JsonProperty("status")
  private String status = "201";

  @JsonProperty("id")
  private String id = "Document imported.";
  ...
  public SucessResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, sucessResponse.status) &&
        Objects.equals(this.id, sucessResponse.id);
  }
